...
export const Default_Payload: MusicPermissionsPayload = {
  ...
  who_can_manage_queue: new Set<UnifiedMemberRole>(["administrator", "owner"]),
  who_can_add_track: new Set<UnifiedMemberRole>(["everyone"]),
  who_can_remove_track: new Set<UnifiedMemberRole>(["everyone"]),
  who_can_move_track: new Set<UnifiedMemberRole>(["everyone"]),
  who_can_bypass_vote: new Set<UnifiedMemberRole>(["noone"]),
