...
function Page() {
    ...
    const invite_pona_with_oauth = `https://discord.com/oauth2/authorize?client_id=${clientId}&permissions=690008452688&response_type=code&redirect_uri=${encodeURIComponent(redirect_uri+"?from=invite")}&integration_type=0&scope=identify+guilds+guilds.members.read+bot`;
