    ...
    return (
        <div className='w-full h-full min-h-screen flex'>
            <div className='m-auto flex flex-col gap-2 text-center items-center'>
                <Compass size={48} />
                <strong className='text-3xl'>Redirecting..</strong>
                <p className='text-xl'>if redirecting not working, u can <Link className='underline' href={invite_link}>click me</Link>!</p>
            </div>
        </div>
    )
}
