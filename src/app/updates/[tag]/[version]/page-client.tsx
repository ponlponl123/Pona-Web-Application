...
import { BellSimpleIcon, CaretLeftIcon } from "@phosphor-icons/react"
    ...
    <article className="min-h-screen w-full max-w-3xl">
      ...
      <div className="flex w-full flex-col items-start justify-start">
        ...
        <motion.div
          ...
          className="prose markdown dark:prose-invert relative my-6 block h-max w-full max-w-full text-foreground"
        >
