      ...
      <div className='grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20'>
        <main className='w-full max-w-screen-lg flex flex-col gap-8 row-start-2 items-center sm:items-start'>
          ...
          <ol className='list-inside text-sm text-center sm:text-left list-none -mt-6 mb-2'>
            <li className='mb-2 text-xl max-md:text-lg max-miniscreen:text-base'>
              {language.data.home.mindselector.title}
            </li>
            <li>
              <div>
                <Select
                ...
                >
                  {minds.map(mind => (
                    <SelectItem key={mind.key} startContent={mind.startContent}>
                      {
                        language.data.mind[
                          mind.key as keyof typeof language.data.mind
                        ]
                      }
                    </SelectItem>
                  ))}
          ...
          <div className='flex gap-4 items-center flex-col sm:flex-row'>
            <Link href='/invite' rel='noopener noreferrer'>
              ...
              >
                <Confetti weight='fill' alt='Confetti' />
