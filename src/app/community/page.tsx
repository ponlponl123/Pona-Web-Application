  ...
  return (
    <main className='w-full min-h-screen relative'>
      <Image
        ...
        classNames={{
          wrapper:
            'w-full !max-w-none absolute overflow-hidden h-[48vh] z-[0] blur-3xl max-h-96 min-h-24 scale-[1.1] opacity-60',
        }}
      ...
      <div className='relative flex flex-col grid-rows-[20px_1fr_20px] items-center min-h-screen p-8 pb-20 gap-8 sm:p-20 z-[1]'>
        ...
        <main className='w-full max-w-screen-lg flex flex-col justify-start gap-10 pb-12'>
          ...
          <h2 className='text-2xl -mt-12 font-bold'>
            {language.data.community.description}
          </h2>
          <section className='p-8 bg-foreground/5 border-2 border-foreground/5 rounded-3xl'>
            <h2 className='text-4xl flex items-center gap-4 font-bold'>
              <TextAa size={24} /> {language.data.community.fonts.title}
            </h2>
          ...
          <section className='p-8 bg-foreground/5 border-2 border-foreground/5 rounded-3xl'>
            <h2 className='text-4xl flex items-center gap-4 font-bold'>
              <Article size={24} /> {language.data.community.translator.title}
            </h2>
            <div className='flex flex-col'>
          ...
          <section className='p-8 bg-foreground/5 border-2 border-foreground/5 rounded-3xl'>
            <h2 className='text-4xl flex items-center gap-4 font-bold'>
              <Package size={24} /> {language.data.community.library.title}
            </h2>
            <div className='flex flex-wrap mt-4 gap-2'>
              <Link
              ...
              <Link
                href='https://github.com/discordjs'
                target='_blank'
                isBlock
                showAnchorIcon
              >
              ...
              <Link
                href='https://github.com/andreizanik/cookies-next'
                target='_blank'
                isBlock
                showAnchorIcon
              >
              ...
              <Link
                href='https://github.com/lokesh/color-thief'
                target='_blank'
                isBlock
                showAnchorIcon
              >
              ...
              <Link
                href='https://github.com/jimp-dev/jimp'
                target='_blank'
                isBlock
                showAnchorIcon
              >
              ...
              <Link
                href='https://github.com/openstreetmap'
                target='_blank'
                isBlock
                showAnchorIcon
              >
              ...
              <Link
                href='https://github.com/sibiraj-s/marked-react'
                target='_blank'
                isBlock
                showAnchorIcon
              >
              ...
              <Link
                href='https://github.com/shukerullah/react-geocode'
                target='_blank'
                isBlock
                showAnchorIcon
              >
              ...
              <Link
                href='https://github.com/yocontra/react-responsive'
                target='_blank'
                isBlock
                showAnchorIcon
              >
              ...
              <Link
                href='https://www.npmjs.com/package/@euax/color-palette-generator'
                target='_blank'
                isBlock
                showAnchorIcon
              >
                @euax/color-palette-generator
              </Link>
            </div>
          </section>
        </main>
