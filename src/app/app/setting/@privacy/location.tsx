  ...
  return (
    ...
    >
      ...
      <h3 className='text-xl text-start gap-4 pt-1'>
        {language.data.app.setting.privacy.location.description}
      </h3>
      <RadioGroup
        className='w-full'
        defaultValue={
      ...
      >
        <Radio
          value='auto'
          description={
            language.data.app.setting.privacy.location.auto.description
          }
        >
        ...
        <Radio
          value='custom'
          description={
            language.data.app.setting.privacy.location.custom.description
          }
        >
        ...
        <Radio
          value='surprise'
          description={
            language.data.app.setting.privacy.location.surprise.description
          }
        >
        ...
        <>
          <div className='flex flex-col gap-2'>
            ...
            <span className='text-foreground/30 text-xs'>
              Map by OpenStreetMap 💚, Map Components by Leaflet 🌿
            </span>
          </div>
        </>
      )}
