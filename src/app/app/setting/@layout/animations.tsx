...
function Animations() {
  ...
  return (
    ...
    >
      ...
      <RadioGroup
        className='w-full'
        defaultValue={String(userSetting.animation) || 'true'}
        onValueChange={value => {
          const animateValue: Animation =
            value === 'true'
              ? true
              : value === 'false'
                ? false
      ...
      >
        <Radio
          value='true'
          description={
            language.data.app.setting.layout.animation.smooth.description
          }
        >
        ...
        <Radio
          value='30 fps'
          description={
            language.data.app.setting.layout.animation['30 fps'].description
          }
        >
        ...
        <Radio
          value='false'
          description={
            language.data.app.setting.layout.animation.none.description
          }
        >
