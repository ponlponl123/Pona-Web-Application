...
import { TimeFormat as TimeFormatType, useUserSettingContext } from '@/contexts/userSettingContext'
...
function TimeFormat() {
  ...
  return (
    <section className='w-full min-h-full flex flex-col gap-6' id='layout-timeformat' data-section>
      ...
      <RadioGroup className='w-full' defaultValue={String(userSetting.timeformat || 'auto')}
        onValueChange={(value) => {setUserSetting({...userSetting,timeformat:value as TimeFormatType})}}>
        ...
        <Radio description={language.data.app.setting.layout.time_format[12].description} value="12">
          {language.data.app.setting.layout.time_format[12].title}
        </Radio>
        <Radio description={language.data.app.setting.layout.time_format[24].description} value="24">
