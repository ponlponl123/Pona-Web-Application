        ...
        <div className='flex gap-6 z-10 relative px-12 max-md:px-6'>
            ...
            <div className='flex gap-4 -mt-12 z-10 max-md:hidden'>
              {userInfo ? (
                userInfo.accent_color ? (
                  <div
                    className='w-5 h-5 rounded-full outline outline-2 outline-foreground-100 outline-offset-2'
                    style={{
                      backgroundColor: numberToHexColor(userInfo.accent_color),
                    }}
                  ></div>
                ) : (
          ...
          <div className='bg-foreground-100/25 w-full p-8 max-md:pt-12 rounded-3xl md:rounded-ss-lg mt-4 flex flex-col gap-4'>
            <Chip
              ...
              size='sm'
              startContent={<DiscordLogo className='ml-2 mr-1' weight='fill' />}
            >
            ...
            <div className='flex flex-wrap gap-2 -mb-3'>
              <Link
                ...
                rel='noopener'
                target='_blank'
                href='https://law.ponlponl123.com/pona#terms'
              >
                Terms of Service
              </Link>
              <Link
