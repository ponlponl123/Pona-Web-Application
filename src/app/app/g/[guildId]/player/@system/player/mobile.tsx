  ...
  return (
    <AnimatePresence>
      {currentTrack && <motion.div id='pona=player-wrapper'
          ...
          className={
            `absolute overflow-hidden z-50 bg-gradient-to-br to-[hsl(var(--pona-app-music-accent-color-500)/.24)] from-[hsl(var(--pona-app-music-accent-color-500)/.24)] apply-soft-transition ${playerPopup?'w-full h-screen rounded-none bottom-4 left-0':'h-16 rounded-lg bottom-6 left-2 w-[calc(100%_-_1rem)]'}`
