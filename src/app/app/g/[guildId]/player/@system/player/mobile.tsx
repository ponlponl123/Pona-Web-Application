      ...
      {currentTrack && (
        ...
        >
          ...
          <Slider
            ...
            className={
              'absolute -top-2.5 z-20 group shadow-2xl left-0 w-full max-w-none pointer-events-none' +
          ...
          >
            ...
            <div
              className={
                (!trackFocus && playerPopup
                  ? ' absolute w-[calc(100%_-_4rem)] top-4 left-4'
                  : ' w-full ' +
                    (playerPopup && ' opacity-0 pointer-events-none')) +
            ...
            >
              <motion.div
                className={
                  'flex items-center justify-start gap-4 w-full max-w-[calc(100%_-_5rem)]'
                }
                animate={{
                  transition: {
                    duration: 0.2,
              ...
              >
                ...
                >
                  <div className='text-xl max-w-full flex gap-2'>
                    <h1 className='text-base !text-[hsl(var(--pona-app-music-accent-color-500))] w-full whitespace-nowrap overflow-hidden overflow-ellipsis'>
                  ...
                  <span className='text-xs text-[hsl(var(--pona-app-music-accent-color-500))]/40 w-full whitespace-nowrap overflow-hidden overflow-ellipsis'>
              ...
              >
                {!ponaCommonState?.pona.paused ? (
                  <>
                    <Button
                      isIconOnly
                      radius={!trackFocus && playerPopup ? 'lg' : 'full'}
                      size={!trackFocus && playerPopup ? 'md' : 'lg'}
                      variant='light'
                      onPress={() => {
                        socket?.emit('pause');
                      }}
